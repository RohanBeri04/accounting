...
<div class="container mt-3">
        ...
        <button class="colorBtn"  type="button" data-bs-toggle="modal" data-bs-target="#addClientModal"><i class="fas fa-plus"></i> Add User</button> 
        </h2>   
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="mb-3">
              <label for="clientName" class="form-label">Role <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="clientName" aria-describedby="clientNameHelp" placeholder="Role">
            ...
            <div class="mb-3">
              <label for="clientEmail" class="form-label">New Password <span class="text-danger">*</span></label>
              <input type="email" class="form-control" id="clientEmail" aria-describedby="clientEmailHelp" placeholder="New Password">
             
            </div>
            <div class="mb-3">
              <label for="clientEmail" class="form-label">Confirm Password<span class="text-danger">*</span></label>
              <input type="email" class="form-control" id="clientEmail" aria-describedby="clientEmailHelp" placeholder="Confirm Password">
                                ...
                                <td>
                                   ...
                                   <button  type="button" data-bs-toggle="modal" data-bs-target="#editClientModal"> <i class="fas fa-edit"></i></button>
                                            ...
                                            <div class="modal fade" id="editClientModal" tabindex="-1" aria-labelledby="addClientModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="editClientModalLabel">Edit User Details</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <form>
                            ...
                            <tr>
                                ...
                                <td> <button type="button" data-bs-toggle="modal" data-bs-target="#editClientModal"><i class="fas fa-edit"></i></button>
                                    ...
                                    <div class="modal fade" id="deleteClientModal" tabindex="-1" aria-labelledby="deleteClientModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content text-sm">
                                            ...
                                            <div class="modal-body">
                                            <h3><b>Are you sure to delete the User?</b></h3> <span id="client-name"></span>
                                            </div>
                                ...
                                <div class="modal fade" id="banClientModal" tabindex="-1" aria-labelledby="deleteClientModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content text-sm">
                                            ...
                                            <div class="modal-body">
                                            <h3><b>Are you sure to Block the User?</b></h3> <span id="client-name"></span>
                                            </div>
                                            <div class="modal-footer d-flex alignn-items-center justify-content-center">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
